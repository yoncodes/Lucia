...
namespace Lucia.Common.MsgPack
{
    ...
    public partial class LoginCharacterList
    {
        ...
        public List<dynamic> MagicList { get; set; } = new();
    ...
    public partial class PlayerData
    {
        ...
        public bool IsGetGenderReward { get; set; }
        public long Level { get; set; }
        ...
        public Int32 PcSelectMoneyCardId { get; set; }
        public dynamic PointRecordInfo { get; set; }
    }
    ...
    public partial class TeamGroupDatum
    {
        ...
        public long SelectedGeneralSkill { get; set; }
    }
    ...
    public partial class TimeLimitCtrlConfigList
    {
        ...
        public partial class NotifyLogin
        {
            ...
            public Dictionary<int, TeamPrefabDatum> TeamPrefabData { get; set; }
            ...
            public List<long> HaveBackgroundIds { get; set; } = new();
            public FubenLoginData FubenShortStoryLoginData { get; set; }
            public RandomBackgroundLoginData RandomBackgroundLoginData { get; set; }
            public List<PurchaseClientInfo> PurchaseClientInfoLoginData { get; set; } = new();

            public List<FunctionOpenTimeConfig> FunctionOpenTimeConfigList { get; set; } = new();
            public DlcPlayerData DlcPlayerData { get; set; }
    ...
    public class DlcPlayerData
    {
        ...
        public List<int> PassWorldId { get; set; } = new();
        public int GainAssistPoint { get; set; }
        public int GainSocialAssistPoint { get; set; }
        public bool HasReceiveAssistPoint { get; set; }
    }
    ...
    [global::MessagePack.MessagePackObject(true)]
    public class PurchaseClientInfo
    {
        public int Id { get; set; }
        ...
        public List<RewardGoods> DailyRewardGoodsList { get; set; } = new();

        public RewardGoods? FirstRewardGoods { get; set; }
        public RewardGoods? ExtraRewardGoods { get; set; }
        ...
        public ResetInfo ClientResetInfo { get; set; }

        public bool IsUseMail { get; set; }

        public object? NormalDiscounts { get; set; }
        public object? DiscountCouponInfos { get; set; }
        public object? DiscountShowStr { get; set; }

        public long LastBuyTime { get; set; }

        public List<int>? MutexPurchaseIds { get; set; }
        ...
        public int PrePurchaseId { get; set; }

        public object? PurchaseSignInInfo { get; set; }
        public object? SelectDataForClient { get; set; }

        public int CompanyPackage { get; set; }
        public int CompanyPackageCount { get; set; }
    }
    ...
    [global::MessagePack.MessagePackObject(true)]
        ...
        {
            public bool IsRandomBackground { get; set; }
            public bool IsBackgroundRandomFashion { get; set; }
            public List<dynamic> RandomBackgroundPool { get; set; } = new();
    ...
    [global::MessagePack.MessagePackObject(true)]
        ...
        {
        public List<FubenEventInfo> FubenEventInfos { get; set; } = new();
            
        }

        [global::MessagePack.MessagePackObject(true)]
        public class FubenEventInfo
        {
            public Int32 StageId { get; set; }
            public Dictionary<long, int> EventIdMap { get; set; }
        }

    [global::MessagePack.MessagePackObject(true)]
    public class FubenMainLine2Data
    {
        public object LastPassStage { get; set; }
        public List<dynamic> MainDatas { get; set; } = new();
        public List<dynamic> ChapterDatas { get; set; } = new();
        public object FirstPassTime { get; set; }   
        public int LastExhibitionChapterId { get; set; }
    }

    [global::MessagePack.MessagePackObject(true)]
    public class TeamPrefabDatum
    {
        public Dictionary<int, int?> PartnerData { get; set; } = new();
        public Dictionary<int, int?> EquipData { get; set; } = new();
        ...
        public Dictionary<int, int> TeamData { get; set; } = new();
        public string TeamName { get; set; }
    ...
    [global::MessagePack.MessagePackObject(true)]
        public class NotifyPayInfo
        {
            ...
            public List<dynamic> FirstRewardReceivedList { get; set; }
        }
        ...
        {
            public NotifyLoginAwarenessInfoAwarenessInfo AwarenessInfo { get; set; }

            
        }

        [global::MessagePack.MessagePackObject(true)]
        public class NotifyLoginAwarenessInfoAwarenessInfo
        {
            public List<dynamic> ChapterRecords { get; set; } = new();
            public List<dynamic> ChallengeRecords { get; set; } = new();
    ...
    [global::MessagePack.MessagePackObject(true)]
        ...
        public class NotifyTaskData
        {
            ...
            public class NotifyTaskDataTaskData
            {
                ...
                public long BackFlowEndTime { get; set; }
            }
        ...
        public class NotifyTask
        {
            ...
            public NotifyTaskTasks Tasks { get; set; } = new();
        ...
        public class NotifyBfrtData
        {
            ...
            {
                public bool GroupRewardFlag { get; set; }
                public List<dynamic> BfrtGroupRecords { get; set; } = new();
                public List<dynamic> BfrtTeamInfos { get; set; } = new();
                
                [global::MessagePack.MessagePackObject(true)]
                public class NotifyBfrtDataBfrtDataBfrtProgressInfo
                {
                    public Int32 GroupId { get; set; }
                    public List<dynamic> StageIds { get; set; } = new();
                    
                }

                public NotifyBfrtDataBfrtDataBfrtProgressInfo BfrtProgressInfo { get; set; }
        ...
        [global::MessagePack.MessagePackObject(true)]
        public class NotifyDlcFightCharacterId
    {
            public uint FightCharacterId { get; set; }
        }
    ...
    [global::MessagePack.MessagePackObject(true)]
        public class NotifyDormitoryData
        {
            ...
            public class NotifyDormitoryDataDormQuestData
            {
                ...
                public Int32 TerminalUpgradeTime { get; set; }
                public Int32 TerminalUpgradeStatus { get; set; }
                public List<dynamic> FinishQuests { get; set; } = new();
                public List<dynamic> TriggerLimitedQuest { get; set; } = new();
                public List<dynamic> TotalQuest { get; set; } = new();
                public List<dynamic> QuestAccept { get; set; } = new();
                public List<dynamic> CollectFiles { get; set; } = new();
            }
         public NotifyDormitoryDataDormQuestData DormQuestData { get; set; }
        }
    ...
    [global::MessagePack.MessagePackObject(true)]
        ...
        [global::MessagePack.MessagePackObject(true)]
        public class NotifyDlcChipFormDataList
        {
        public List<ChipFormData> ChipFormDataList { get; set; } = new();
            
            [global::MessagePack.MessagePackObject(true)]
            public class ChipFormData
        {
                public Int32 FormId { get; set; }
                public string Name { get; set; }
                public List<dynamic> ChipPosList { get; set; } = new();
            }
        ...
        [global::MessagePack.MessagePackObject(true)]
        public class NotifyDlcChipAssistChipId
        {
            public Int32 AssistChipId { get; set; } 
        }
        ...
        public class NotifyBiancaTheatreActivityData
        {
            ...
            public object HistoryItemObtainRecords { get; set; }
            public Int32 GamePassNodeCount { get; set; }
            public object PassedEventRecord { get; set; }
        ...
        [global::MessagePack.MessagePackObject(true)]
        public class NotifyTheatre3ActivityData
    {
            public Int32 CurActivityId { get; set; }
            public Int32 CurChapterId { get; set; }
            public Int32 DifficultyId { get; set; }
            public Int32 FirstPassFlag { get; set; }
            public bool ChapterSwitch { get; set; }
            public dynamic? CurChapterDb { get; set; }
            public dynamic? CurTeamData { get; set; }
            public List<Characters> Characters { get; set; } = new();
            public List<dynamic> Equips { get; set; } = new();
            public List<dynamic> EquipPos { get; set; }
            public List<dynamic> Items { get; set; } = new();
            public List<dynamic> UnlockItemId { get; set; } = new();
            public List<dynamic> UnlockEquipId { get; set; }
            public List<dynamic> GetRewardIds { get; set; } = new();
            public List<dynamic> UnlockStrengthTree { get; set; } = new();
            public Int32 TotalBattlePassExp { get; set; }
            public object PassDifficultyRecords { get; set; }
            public List<dynamic> UnlockDifficultyId { get; set; } = new();
            public List<dynamic> TeamRecords { get; set; } = new();
            public List<dynamic> PassChapterIds { get; set; } = new();
            public List<dynamic> FightRecords { get; set; } = new();
            public List<dynamic> AchievementRewards { get; set; } = new();
            public Int32 DestinyCharacterId { get; set; }
            public Int32 DestinyValue { get; set; }
            public Int32 QubitValueA { get; set; }
            public Int32 QubitValueB { get; set; }
            public Int32 TotalAllPassCount { get; set; }
            public List<dynamic> EndingRecord { get; set; } = new();
            public Int32 FireItemCount { get; set; }
            public List<dynamic> PassEventFightNodes { get; set; } = new();
    }
    ...
    public class Characters
    {
        ...
        public Int32 Level { get; set; }
        public Int32 Exp { get; set; }
        public Int32 ExpTemp { get; set; }
        public Int32 PassFightCount { get; set; }
        public Int32 PassDiffFightCount { get; set; }
        public Int32 PassBossFightCount { get; set; }
        public List<dynamic> EndingIds { get; set; } = new();
    ...
    public class NotifyNewActivityCalendarData
    {
        ...
        [global::MessagePack.MessagePackObject(true)]
        public class NotifyNewActivityCalendarDataNewActivityCalendarData
        {
            public List<dynamic> TimeLimitActivityInfos { get; set; } = new();
            ...
            public class WeekActivityInfo
            {
                ...
                public List<dynamic> GotRewards { get; set; } = new();
            }

            public List<WeekActivityInfo> WeekActivityInfos { get; set; } = new();
        }

        public NotifyNewActivityCalendarDataNewActivityCalendarData NewActivityCalendarData { get; set; }
            = new();

        public long CurrentGuildBossEndTime { get; set; }
    }
    ...
    [global::MessagePack.MessagePackObject(true)]
        ...
        public class EquipData
        {
            ...
            public UInt32 CreateTime { get; set; }
            public EquipDataWeaponOverrunData WeaponOverrunData { get; set; }
            public Boolean IsRecycle { get; set; }

        }

        [global::MessagePack.MessagePackObject(true)]
        public class EquipDataWeaponOverrunData
        {
            public Int32 Level { get; set; }
            public List<dynamic> ActiveSuits { get; set; } = new();
